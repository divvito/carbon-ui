...
this.props,mergeTheme=_props.mergeTheme,rest=_objectWithoutProperties(_props,['mergeTheme']);
return(
_react2.default.createElement(WrappedComponent,_extends({},
rest,{
ref:function ref(c){_this3._node=c;},
theme:(0,_merge2.default)(this.context.theme||_index.themes.light,mergeTheme||{})})));

}}]);return ConnectTheme;}(_react.Component);


ConnectTheme.propTypes={
mergeTheme:_propTypes2.default.object};
