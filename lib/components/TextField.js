...
this.props,style=_props.style,textInputStyle=_props.textInputStyle,placeholderStyle=_props.placeholderStyle,placeholder=_props.placeholder,theme=_props.theme,disabled=_props.disabled,error=_props.error,singleLine=_props.singleLine,textInputProps=_props.textInputProps,textFieldErrorProps=_props.textFieldErrorProps,placeholderProps=_props.placeholderProps,other=_objectWithoutProperties(_props,['style','textInputStyle','placeholderStyle','placeholder','theme','disabled','error','singleLine','textInputProps','textFieldErrorProps','placeholderProps']);var

styles=this.styles;

return(
_react2.default.createElement(_reactNative.View,{style:[styles.base,style]},
...
css:styles.divider}),
_react2.default.createElement(_index.TextFieldError,textFieldErrorProps,error)));
...
textFieldErrorProps:_propTypes2.default.object,

placeholderProps:_propTypes2.default.object,
