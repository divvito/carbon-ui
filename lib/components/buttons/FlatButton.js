...
{var disabled=_ref.disabled,children=_ref.children,theme=_ref.theme,textStyle=_ref.textStyle,style=_ref.style,other=_objectWithoutProperties(_ref,['disabled','children','theme','textStyle','style']);
...
css:_reactNative.StyleSheet.flatten([styles.base,disabled&&styles.disabled,style]),
disabled:disabled},
other),
formattedChildren));
